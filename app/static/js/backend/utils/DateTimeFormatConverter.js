...
export default class DateTimeFormatConverter {
    ...
    /**
     * Convert a MomentJS datetime format to an ElementUI DateTimePicker format
     *
     * @param string
     * @returns {string}
     */
    static momentToElementUi(string) {
        if (string) {
            return this.convertFormat(elementUiFormatMapping, string)
        } else {
            throw "Empty input string provided!"
        }
    }
